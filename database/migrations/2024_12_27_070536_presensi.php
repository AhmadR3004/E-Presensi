...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('presensi', function (Blueprint $table) {
            ...
            $table->time('jam_in'); // Waktu jam masuk
            $table->time('jam_out'); // Waktu jam keluar
            $table->string('foto_in'); // Path/nama file foto masuk
            $table->string('foto_out'); // Path/nama file foto keluar
            $table->text('location');
