<div id="createPegawaiModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-3xl h-full md:h-auto">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-900 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Add Pegawai</h3>
                <button type="button"
                    class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                    data-modal-toggle="createPegawaiModal">
            ...
            <form action="{{ route('pegawai.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    <button type="submit"
                        ...
                        Pegawai</button>
                    <button data-modal-toggle="createPegawaiModal" type="button"
